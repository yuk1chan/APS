...
void initial(double *x, int &N, int &N0, double &Vref,
             ...
             double &Esum, double &nequil, double &a, double &b);
...
void walk(double *x, int &N, int &N0, double &Vref,
          double &Vave, double const ds, double const dt, double const &a, double const &b);
...
void initial(double *x, int &N, int &N0, double &Vref,
             ...
             double &Esum, int &nequil, double &a, double &b){
