...
set yrange [ -5.00000 : 5.00000 ] noreverse writeback
...
V1(x) = x*x/2 + 0.1*x*x*x
V2(x) = x*x/2 + 0.2*x*x*x
V3(x) = x*x/2 + 0.5*x*x*x
GNUTERM = "x11"
plot V1(x) title "b = 0.1", V2(x) title "b = 0.2", V3(x) title "b = 0.5"
#    EOF
